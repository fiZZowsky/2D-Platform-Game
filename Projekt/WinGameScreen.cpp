...
void WinGameScreen::updateScore() {
...
void WinGameScreen::updateMousePosition(sf::Vector2i mousePosition) {
...
bool WinGameScreen::isMouseOverBackButton() const {
